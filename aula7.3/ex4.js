...
//retorna "fizz" se for divisível apenas por 3, retorna "buzz" se divisível apenas por 5, retorna o próprio número 
...
assert.notDeepStrictEqual(myFizzBuzz(15), true);
